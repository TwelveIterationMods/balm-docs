...
:::tip
There is some other cool new features in this release as well, such as [Declarative Quick Move](/docs/utilities/quick-move), progress renderer utilities, a safe-to-access `isShiftDown` for tooltips [and other minor things](https://github.com/TwelveIterationMods/Balm/blob/d1fc837bf136e157df607d4fd301f1385043701b/CHANGELOG.md).
:::
