...
It was already visible-source before, which may have misled some into thinking it was open source all along, but now it's official.

{/* truncate */}

I was hesitant to make this change due to prior bad experiences with being too permissive when it came to my work, 
but I think this is a good compromise that should help Balm grow and make it a more reliable choice for other mod developers.
