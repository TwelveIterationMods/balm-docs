  ...
  >
    ...
    <path
      ...
      style="
        ...
        stroke-opacity: 0;
        pointer-events: none;
        fill: url(#gradient-2-0);
      "
      bx:shape="n-gon 250 250 173.656 170.327 6 0.1 1@29ef28a4"
    >
    ...
    <path
      d="M 251.072 139.213 L 250 364.5 L 147.942 325.616 L 153.883 193.908 L 251.072 139.213 Z"
      style="stroke: rgb(0, 0, 0); stroke-opacity: 0; fill: url(#gradient-4-0)"
    >
      <title>Inner Left</title>
    </path>
    <path
      d="M 251.03 139.2 L 349.252 195.9 L 347.02 331.662 L 249.958 364.487 L 251.03 139.2 Z"
      style="stroke: rgb(0, 0, 0); stroke-opacity: 0; fill: url(#gradient-4-1)"
    >
      <title>Inner Right</title>
    </path>
    <path
      d="M 250 190.035 L 300.624 220.017 L 300.624 279.983 L 250 309.965 L 199.376 279.983 L 199.376 220.017 Z"
      style="
        stroke: rgb(0, 0, 0);
        ...
        pointer-events: none;
      "
      bx:shape="n-gon 250 250 58.456 59.965 6 0 1@36a3f7ad"
    >
      <title>Inner Cube</title>
    </path>
    <path
      d="M 255.017 395.032 C 225.853 289.87 272.449 254.234 250.066 268.606 C 250.066 268.606 199.438 302.633 199.438 313.988 C 194.143 356.802 236.549 387.687 255.017 395.032 Z"
      style="
        stroke: rgb(0, 0, 0);
        paint-order: fill;
        stroke-opacity: 0;
        transform-origin: 294.776px 291.221px;
        fill: url(#gradient-3-1);
        pointer-events: none;
      "
      transform="matrix(-1, 0, 0, -1, 0.000009, 0.000009)"
    >
      <title>Right Inner Flap</title>
    </path>
    <path
      d="M 401.2 208.763 C 401.2 208.763 396.187 207.325 386.161 213.002 L 265.849 281.133 C 255.822 286.81 250.809 295.327 250.809 306.682 C 245.507 349.496 267.294 408.877 285.787 416.222 C 231 322.834 360.132 295.525 401.2 260.313 L 401.2 208.763 Z"
      style="
        stroke: rgb(0, 0, 0);
        paint-order: fill;
        stroke-opacity: 0;
        ...
        pointer-events: none;
      "
      transform="matrix(-1, 0, 0, -1, 0.000049, -0.000014)"
    >
      <title>Right Flap</title>
    </path>
    <path
      d="M 165.434 187.4 C 136.27 292.562 182.866 328.198 160.483 313.826 C 160.483 313.826 109.855 279.799 109.855 268.444 C 104.56 225.63 146.966 194.745 165.434 187.4 Z"
      style="
        stroke: rgb(0, 0, 0);
        paint-order: fill;
        stroke-opacity: 0;
    ...
    <path
      d="M 250 416.05 C 250 416.05 244.987 417.488 234.961 411.811 L 114.649 343.68 C 104.622 338.003 99.609 329.486 99.609 318.131 C 94.307 275.317 116.094 215.936 134.587 208.591 C 79.8 301.979 208.932 329.288 250 364.5 L 250 416.05 Z"
      style="
        stroke: rgb(0, 0, 0);
        paint-order: fill;
        stroke-opacity: 0;
